...
<div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
    ...
    <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-800 p-5 flex flex-col gap-4">
        ...
        <div class="grid grid-cols-2 gap-2">
            <button type="button"
                onclick="document.getElementById('modal-edit-counter-{{ $counter->id }}').classList.remove('hidden')"
...
@foreach($counters as $counter)
<div id="modal-edit-counter-{{ $counter->id }}" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
    <div class="w-full max-w-md bg-white dark:bg-gray-900 rounded-3xl shadow-2xl p-7 ring-1 ring-gray-200 dark:ring-gray-700">
        <div class="flex items-center justify-between mb-6">
            ...
            <button type="button" onclick="document.getElementById('modal-edit-counter-{{ $counter->id }}').classList.add('hidden')"
