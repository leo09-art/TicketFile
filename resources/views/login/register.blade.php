...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <div class="bg-white rounded-lg shadow-xl p-8">
            ...
            <p class="text-center text-gray-600 mb-8">Créer votre compte</p>
            ...
            <form method="post" action="{{ route('register.store') }}">
                ...
                <button
                    type="reset"
                    class="w-full bg-gray-400 hover:bg-gray-500 text-white font-semibold py-2 px-4 rounded-lg transition duration-200 transform hover:scale-105"
                >
                    Annuler
                </button>
            </form>
